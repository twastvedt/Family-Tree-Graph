...
var d3 = require('d3');
var Data = (function () {
    function Data(xmlDoc) {
        this.tree = new Tree();
        this.familiesToDo = d3.map();
        this.parseData(xmlDoc);
    }
    Data.prototype.parseData = function (xmlDoc) {
        this.svg = d3.select('body').append('svg:svg');
        this.xml = d3.select(xmlDoc);
        var rootFamilyHandle = this.xml.select('family#' + settings_1.default.rootFamilyId)
            .attr('handle');
        ...
        while (this.familiesToDo.size()) {
            var familyId = this.familiesToDo.keys()[0], family;
            ...
            var familyData = this.familiesToDo.get(familyId), level = familyData.level, sortList = familyData.sorting;
            family.level = level;
            this.tree.maxLevel = Math.max(this.tree.maxLevel, level);
            this.familiesToDo.remove(familyId);
            for (var _i = 0, _a = family.parents; _i < _a.length; _i++) {
                var parent = _a[_i];
            ...
            for (var i = 0; i < family.children.length; i++) {
                ...
                if (child.hasOwnProperty('parentIn') && !this.tree.families.hasOwnProperty(child.parentIn.handle)) {
                    this.familiesToDo.set(child.parentIn.handle, {
                        'level': child.level,
                        'sorting': [{ 'rel': TreeNode.SortRelation.Parent, 'order': 0 }].concat(child.sortList)
                    });
                }
        ...
        for (var i = 0; i < this.tree.levels.length; i++) {
            ...
            this.tree.levelAvg[i] = new Date(d3.mean(this.tree.levels[i], function (el) { return el.hasOwnProperty('birth') ? el.birth.valueOf() : null; }));
        }
        for (i = 0; i < this.tree.levels.length; i++) {
            var length = this.tree.levels[i].length, curLevel = this.tree.levels[i];
            for (var j = 0; j < length; j++) {
                var person = curLevel[j], theta = j / length * 2 * Math.PI, coords = new Pt_1.default(i * settings_1.default.ringSpacing, theta).fromPolar();
                person.x = coords[0];
                person.y = coords[1];
            }
        }
    };
    Data.prototype.addParentSorting = function (family, parent, sortList) {
        if (!parent.complete) {
            parent.setup(this);
        }
        ...
        if (parent.hasOwnProperty('childOf') &&
            ...
            this.familiesToDo.set(parent.childOf.handle, {
                ...
                'sorting': [{ 'rel': TreeNode.SortRelation.Child, 'order': 0 }].concat(parent.sortList)
            });
        }
        this.tree.links.push({
            'source': parent,
...
var LinkSource;
(function (LinkSource) {
    LinkSource[LinkSource["Family"] = 0] = "Family";
...
var Tree = (function () {
    ...
    Tree.prototype.sortLevel = function (a, b) {
        var aLen = a.sortList.length, bLen = b.sortList.length, minLen = Math.min(aLen, bLen);
        for (var i = 1; i <= minLen; i++) {
            var aSort = a.sortList[aLen - i], bSort = b.sortList[bLen - i];
    ...
    ;
    Tree.prototype.addToLevel = function (person, level) {
    ...
    ;
    Tree.prototype.addToDateRange = function (d) {
        if (this.dateRange[0]) {
...
exports.Tree = Tree;
},{"./Pt":4,"./TreeNode":5,"./settings":8,"d3":1}],3:[function(require,module,exports){
'use strict';
var d3 = require('d3');
var settings_1 = require('./settings');
var Pt_1 = require('./Pt');
var Data_1 = require('./Data');
var Nodes = require('./TreeNode');
var Graph = (function () {
    function Graph(xmlDoc) {
        this.data = new Data_1.Data(xmlDoc);
        this.data.tree.nodeList = d3.values(this.data.tree.people).concat(d3.values(this.data.tree.families));
        this.scale = d3.time.scale()
            .domain(this.data.tree.dateRange)
            .range([settings_1.default.width / 2, 0]);
        this.setupGraph();
    }
    Graph.prototype.setupGraph = function () {
        var _this = this;
        var width = window.innerWidth - 50, svgNode = this.data.svg.node(), height = window.innerHeight - svgNode.getBoundingClientRect().top - 50;
        this.data.svg.attr({
            'width': width,
            'height': height
        });
        this.force = d3.layout.force()
            .gravity(settings_1.default.gravity)
            .charge(settings_1.default.charge)
            .friction(settings_1.default.friction)
            .alpha(settings_1.default.alpha)
            .size([1, 1])
        ...
        var parentLinks = links.filter('.parent'), childLinks = links.filter('.child');
        var nodes = main.selectAll('.node')
            .data(this.data.tree.nodeList, function (d) { return d.handle; })
            .enter().append('g')
            .attr({
            'class': function (d) {
                var c = 'node ' + d.constructor.name;
        ...
        people.filter(function (d) { return !d.hasOwnProperty('childOf'); })
            ...
            'class': 'link tail',
            'x1': 0,
            'y1': function (d) { return settings_1.default.ringSpacing * d.level; },
            'x2': 0,
            'y2': function (d) { return settings_1.default.ringSpacing * (d.level + 0.5); }
        });
        people.filter(function (d) { return d.birth; })
            .append('line')
            .attr({
            'class': 'lifeLine',
            'x1': 0,
            'y1': function (d) { return _this.scale(d.birth); },
            'x2': 0,
            'y2': function (d) { return _this.scale(d.death ? d.death : new Date()); }
        });
        this.force.on('tick', function () {
            people.each(function (d) {
                if (d.x && d.y) {
                    var loc = d.Pt(), currentPolar = loc.toPolar(), newPos = new Pt_1.default(d.level * settings_1.default.ringSpacing, currentPolar[1]).fromPolar();
                    d.x = newPos[0];
                    d.y = newPos[1];
                    d.polar = currentPolar;
                    d3.select(this).select('.name').attr('transform', function (d) {
                        var transform = 'translate(0, ' + (d.level + 0.5) * settings_1.default.ringSpacing + ')';
                        if (d.y < 0) {
            ...
            families.each(function (d) {
                if (d.x && d.y && d.father && d.mother) {
                    var fatherPolar = new Pt_1.default(d.father.x, d.father.y).toPolar(), avgPos = [(d.father.x + d.mother.x) / 2, (d.father.y + d.mother.y) / 2], currentPolar = new Pt_1.default(fatherPolar[0], Math.atan2(avgPos[1], avgPos[0])), newPos = currentPolar.fromPolar();
                    d.x = newPos[0];
                    d.y = newPos[1];
                    d.polar = currentPolar;
                }
        ...
        d3.select('#button-playPause').on('click', function () {
            _this.playPause();
        });
        this.force.linkDistance(function (d) {
            switch (d.type) {
                case Nodes.SortRelation.Parent:
                    return settings_1.default.ringSpacing * settings_1.default.parentLinkDistance;
                case Nodes.SortRelation.Child:
                    return settings_1.default.ringSpacing * settings_1.default.childLinkDistance;
                default:
                    return 1;
            }
        })
    ...
    ;
    Graph.prototype.playPause = function () {
...
exports.Graph = Graph;
},{"./Data":2,"./Pt":4,"./TreeNode":5,"./settings":8,"d3":1}],4:[function(require,module,exports){
"use strict";
var Pt = (function () {
    function Pt(x, y) {
        this[0] = x;
    ...
    ;
    Pt.prototype.toPolar = function () {
        return new Pt(Math.sqrt(this[0] * this[0] + this[1] * this[1]), Math.atan2(this[1], this[0]));
    };
    ;
    Pt.prototype.fromPolar = function () {
        return new Pt(Math.cos(this[1]) * this[0], Math.sin(this[1]) * this[0]);
    };
    ;
    Pt.prototype.radialAlign = function () {
        var polarPt = this.toPolar(), a = polarPt[1] * 360 / 2 / Math.PI;
        if (a > 0) {
            return a - 90;
        }
        else {
    ...
    ;
    Pt.prototype.fromLocal = function (elem, doc) {
        var offset = doc.getBoundingClientRect(), matrix = elem.getScreenCTM();
        return new Pt((this[0] / matrix.a) + (this[1] / matrix.c) - matrix.e + offset.left, (this[0] / matrix.b) + (this[1] / matrix.d) - matrix.f + offset.top);
    };
    ;
    Pt.prototype.toLocal = function (elem, doc) {
        var offset = doc.getBoundingClientRect(), matrix = elem.getScreenCTM();
        return new Pt((matrix.a * this[0]) + (matrix.c * this[1]) + matrix.e - offset.left, (matrix.b * this[0]) + (matrix.d * this[1]) + matrix.f - offset.top);
    };
    ;
...
var TreeNode = (function () {
    function TreeNode(handle) {
        var _this = this;
        this.handle = handle;
        this.Pt = function () { return new Pt_1.default(_this.x, _this.y); };
    }
    return TreeNode;
}());
...
var Person = (function (_super) {
    ...
    Person.prototype.setup = function (data) {
        this.complete = true;
        ...
        if (!person.empty()) {
            ...
            if (!person.select('parentin').empty()) {
                var familyHandle = person.select('parentin').attr('hlink');
            ...
            person.selectAll('eventref').each(function () {
                ...
                if (!e.empty()) {
                    switch (e.select('type').text()) {
                        case 'Birth':
                            thisPerson_1.birth = new Date(e.select('dateval').attr('val'));
                            data.tree.addToDateRange(thisPerson_1.birth);
                            break;
                        case 'Death':
                            thisPerson_1.death = new Date(e.select('dateval').attr('val'));
                            data.tree.addToDateRange(thisPerson_1.death);
                            break;
                        default:
...
var Family = (function (_super) {
    ...
    function Family(handle, data, doSetup) {
        _super.call(this, handle);
        this.parents = [];
        this.children = [];
    ...
    Family.prototype.setup = function (data) {
        this.complete = true;
        ...
        if (!family.empty()) {
            ...
            var thisFamily_1 = this;
            family.selectAll('eventref').each(function () {
                var e = data.xml.select('event[handle=' + this.getAttribute('hlink') + ']');
                if (!e.empty()) {
                    switch (e.select('type').text()) {
                        case 'Marriage':
                            thisFamily_1.marriage = new Date(e.select('dateval').attr('val'));
                            data.tree.addToDateRange(thisFamily_1.marriage);
                            break;
                        default:
            ...
            family.selectAll('childref').each(function () {
                ...
                if (data.tree.people[handle]) {
                    thisFamily_1.children.push(data.tree.people[handle]);
                }
                else {
                    thisFamily_1.children.push(new Person(handle, data));
                }
            });
        }
        else {
    ...
    Family.prototype.arc = function () {
        ...
        var startP = start.toPolar(), endP = end.toPolar(), dTheta = endP[1] - startP[1];
        dTheta += (dTheta > Math.PI) ? -(Math.PI * 2) : (dTheta < -Math.PI) ? (Math.PI * 2) : 0;
        var largeArc = (Math.abs(dTheta) > 180) ? 1 : 0, sweep = (dTheta > 0) ? 1 : 0, r = this.level * settings_1.default.ringSpacing;
...
;
(function (Spouse) {
    Spouse[Spouse["Father"] = 0] = "Father";
    Spouse[Spouse["Mother"] = 1] = "Mother";
})(exports.Spouse || (exports.Spouse = {}));
var Spouse = exports.Spouse;
;
(function (SortRelation) {
    SortRelation[SortRelation["Child"] = 0] = "Child";
    SortRelation[SortRelation["Spouse"] = 1] = "Spouse";
    SortRelation[SortRelation["Parent"] = 2] = "Parent";
    SortRelation[SortRelation["Sibling"] = 3] = "Sibling";
})(exports.SortRelation || (exports.SortRelation = {}));
var SortRelation = exports.SortRelation;
;
;
},{"./Pt":4,"./settings":8}],6:[function(require,module,exports){
"use strict";
var Graph_1 = require('./Graph');
var d3 = require('d3');
var graph;
d3.xml('./data/family-tree.xml', function (error, xmlDoc) {
    graph = new Graph_1.Graph(xmlDoc);
});
},{"./Graph":3,"d3":1}],7:[function(require,module,exports){
module.exports={
	//ID of starting family
	"rootFamilyId": "F0000",

	//distance between generations
	"ringSpacing": 75,

	//diameter of circle graph, in pixels(?)
	"width": 1000,

	//maximum change in node position per tick due to any single force
	"constraintStrength": 0.2,

	"gravity": 0,

	//link lengths as factors of ringSpacing
	"childLinkDistance": 0.9,

	"parentLinkDistance": 0.3,
...
},{"./settings.json":7}],9:[function(require,module,exports){

},{}],10:[function(require,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"dup":9}]},{},[6,10,9])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
